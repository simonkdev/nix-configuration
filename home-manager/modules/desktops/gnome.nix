  ...
  dconf = {
    ...
    settings = {
      ...
      "org/gnome/shell/extensions/azclock" = {
        ...
        widgets."38824b70-97c3-42fb-8be5-2171cdd0d4dd".enabled = true;
      };
      ...
      "org/gnome/shell/extensions/azclock/widget-data/38824b70-97c3-42fb-8be5-2171cdd0d4dd" = {
        ...
        elements = [
          {"d4d1e99f-fe00-4520-bcf2-1c6e1e63b434" = {enabled = true;};}
        ];
        location = [1920 48];
        name = "Weather Widget";
      ...
      "org/gnome/shell/extensions/azclock/widget-data/38824b70-97c3-42fb-8be5-2171cdd0d4dd/element-data/d4d1e99f-fe00-4520-bcf2-1c6e1e63b434" = {
        ...
        # locations is a complex GVariant, you may need to use lib.hm.gvariant.mkVariant or similar for full fidelity
        name = "Weather Forecast";
        polling-interval = 300;
        show-current-apparent-temp = true;
        show-daily-forecast = false;
        show-location = false;
        # weather-actor-shadow is a tuple, use a list for simple cases
        weather-actor-shadow = [false "rgba(0, 0, 0, 0.4)" 0 2 0 4];
      };
